...
export const VIA = [
  ...
  ["Trabajo", "Es autorización de residencia Y TRABAJO para investigación: puede trabajar a tiempo completo, sin límite de horas, en actividades de formación, investigación, desarrollo e innovación (contrato predoctoral, proyectos, I+D en empresas; en la modalidad UE, también dar clases relacionadas). NO cubre empleos ajenos a la investigación (hostelería, comercio…): en eso es más restrictiva que la estancia de máster, que permite cualquier trabajo hasta 30 h/semana. Sin confirmar: si el doctorando sin contrato puede obtener permiso aparte para otro empleo y si los familiares pueden trabajar. No prometerlo."],
