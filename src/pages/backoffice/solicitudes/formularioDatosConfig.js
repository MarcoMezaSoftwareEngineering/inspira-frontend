...
export const FIELD_CONFIG = {
  ...
  especializaciones:           { label: "Temas de interés",             section: "Preferencias del máster",
                                 format: (v) => Array.isArray(v) ? v.filter(Boolean).join(" · ") : v },
  masteres_enlaces:            { label: "Máster de referencia (enlace)", section: "Preferencias del máster", fullWidth: true,
                                 format: (v) => Array.isArray(v) ? v.filter(Boolean).join(" · ") : v },
  objetivo_master:             { label: "Para qué lo quiere",           section: "Preferencias del máster",
                                 format: (v) => ({
                                   trabajar_espana: "Quedarse a trabajar en España", laboral: "Quedarse a trabajar en España",
                                   volver_pais: "Volver a su país con el título",
                                   doctorado: "Investigación o doctorado", investigacion: "Investigación o doctorado",
                                   cambiar_campo: "Cambiar de campo profesional", indiferente: "No lo tiene claro",
                                 })[v] || v },
  descartes:                   { label: "Lo que no quiere",             section: "Preferencias del máster",
                                 format: (v) => Array.isArray(v) ? v.map((d) => ({
                                   semipresencial: "nada semipresencial", sin_practicas: "nada sin prácticas",
                                   investigacion: "nada de investigación", interuniversitario: "nada interuniversitario",
                                   titulo_propio: "ningún título propio", mas_de_un_anio: "nada de más de un año",
                                   en_ingles: "nada en inglés",
                                 })[d] || d).join(" · ") : v },
  descartes_nota:              { label: "Nota sobre descartes",         section: "Preferencias del máster", fullWidth: true },
