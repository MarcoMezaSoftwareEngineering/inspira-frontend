...
.enl-wa svg { width: 30px; height: 30px; flex: 0 0 auto; }
@keyframes enl-wa-entra { from { opacity: 0; transform: translateY(24px) scale(.8); } to { opacity: 1; transform: none; } }
@keyframes enl-wa-late { 0% { box-shadow: 0 0 0 0 rgba(37,211,102,.6); } 80%, 100% { box-shadow: 0 0 0 16px rgba(37,211,102,0); } }
@media (prefers-reduced-motion: reduce) { .enl-wa, .enl-wa::before { animation: none; } }
